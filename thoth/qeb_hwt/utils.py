...
def _add_packages_in_advised_pipfile_to_md_report(product: dict, is_dev: bool):
    ...
    data = {"package_name": packages_names, "pakage_version": packages_versions}
...
def _add_packages_in_advised_pipfile_lock_to_md_report(product: dict, is_dev: bool):
...
def _add_runtime_environment_to_md_report(product: dict):
    """Add Packages in Advised Pipfile.lock to final report."""
    md_report = ""
